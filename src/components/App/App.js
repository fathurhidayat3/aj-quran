...
class App extends Component {
  ...
  getSurats() {
    axios.get(`${"https://cors-anywhere.herokuapp.com/"}https://api.alquran.cloud/surah`).then(result => {
      this.setState({
  ...
  onSearchSubmit = keyword => {
    ...
    axios
      .get(`${"https://cors-anywhere.herokuapp.com/"}https://api.alquran.cloud/search/${keyword}/all/id.indonesian`)
      .then(result => {
